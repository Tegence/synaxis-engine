...
const libraryMCPClientSkillAuthoringLeaseColumns = `id,client_id,client_epoch,granted_by,granted_at,expires_at,remaining_creates,revoked_at,revoked_by,created_at,updated_at,kind,target_skill_id,target_version_id,target_version_digest,target_binding_id,target_binding_digest,target_binding_generation`
...
INSERT INTO narthex_library_mcp_client_skill_authoring_leases
	    (id,client_id,client_epoch,granted_by,granted_at,expires_at,remaining_creates,revoked_at,revoked_by,created_at,updated_at,kind,target_skill_id,target_version_id,target_version_digest,target_binding_id,target_binding_digest,target_binding_generation)
VALUES ($1,$2,$3,$4,$5,$6,$7,NULL,'',$5,$5,$8,'','','','','',0)`,
		lease.ID, lease.MCPClientID, lease.MCPClientEpoch, grantedByEncrypted, lease.GrantedAt, lease.ExpiresAt, lease.RemainingCreates, lease.Kind,
	); err != nil {
		return LibraryMCPClientSkillAuthoringLease{}, err
	}
...
INSERT INTO narthex_library_mcp_client_skill_authoring_leases
	    (id,client_id,client_epoch,granted_by,granted_at,expires_at,remaining_creates,revoked_at,revoked_by,created_at,updated_at,kind,target_skill_id,target_version_id,target_version_digest,target_binding_id,target_binding_digest,target_binding_generation)
VALUES ($1,$2,$3,$4,$5,$6,$7,NULL,'',$5,$5,$8,$9,$10,$11,$12,$13,$14)`,
...
FOR SHARE`, skill.ID))
		...
		item := LibraryMCPClientSkillAuthoringSkill{
			...
			LatestVersionID: head.ID, LatestVersion: head.Version, LatestVersionDigest: head.Digest,
...
ORDER BY s.updated_at DESC,s.id DESC`, client.ID, LibraryMCPClientSkillAuthoringAuditActionConsumed, LibraryMCPClientSkillAuthoringAuditOperationCreate)
	...
	for rows.Next() {
		...
		if err := rows.Scan(
			...
			&candidate.item.LatestVersionID, &candidate.item.LatestVersion, &candidate.item.LatestVersionDigest,
