...
var ErrLibraryResolutionContextInvalid = errors.New("invalid library resolution context")
...
func ResolveLibrarySkillsForAgentSurface(ctx context.Context, store LibraryStore, agentSurfaceID string) (LibrarySkillResolution, error) {
	...
	return libraryResolutionForAgentSurfaceSelections(agentSurfaceID, selections)
}
...
func libraryResolutionForAgentSurfaceSelections(agentSurfaceID string, selections []LibraryAgentSurfaceSkillSelection) (LibrarySkillResolution, error) {
	result := LibrarySkillResolution{Skills: []LibraryResolvedSkill{}, AuthorityNotice: libraryResolutionAuthorityNotice}
