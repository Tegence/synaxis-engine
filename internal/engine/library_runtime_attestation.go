...
func validateLibraryRuntimeAttestationSelection(client MCPClient, parsed parsedLibraryRuntimeAttestation, selections []LibraryAgentSurfaceSkillSelection) error {
	resolution, err := libraryResolutionForAgentSurfaceSelections(client.ID, selections)
	if err != nil {
